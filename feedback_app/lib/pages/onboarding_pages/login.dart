  ...
  Future<void> login() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (res['non_field_errors'] == null) {
        ...
        notifier.changePage(page: PageName.home, unknown: false, pageIndex: 0);
      } else {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('Error: ${res['non_field_errors']}'),
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              notifier.changePage(
                  page: PageName.onboarding, unknown: false, pageIndex: 1);
            },
          ),
        ),
